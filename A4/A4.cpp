...
class Robot
{
	...
	private:
		...
		Eigen::MatrixXd R; // Mesurement  Noise Marker (dist,angle)
		Eigen::MatrixXd Rc; // Mesurement  Noise Compass
		Eigen::MatrixXd Rs; // Mesurement  Noise  Satellite HERE
...
void Robot::LocalizeS(void)
{
	...
	for(i=0;i<num_satellites;i++){
        ...
        // Getting the Jacobian and using it
...
//	add_satelite(20,5,-M_PI); // Moving towards up
	add_satelite(5,-10,M_PI*.5); // Moving across y

	//add_satelite(3,10,M_PI*-.5); // Moving acrossy
}
